...
seo:
  title: Italy Long-Term Residence – Absence Rule | Immio
  description: >
    No absence over 180 days per trip and no more than 10 months away keeps 5
    years of Italian residence continuous. The permesso is due within 8 working
    days.
...
sources:
  - title: Polizia di Stato — Permesso di soggiorno
    ...
    type: official
  - title: Ministero dell'Interno — Immigration and asylum
...
pending, which is often a long wait.
...
- **Long-term residence is not citizenship.** Italian nationality has its own separate and generally longer residence
  requirement, and being a long-term resident doesn't confer it.
...
### A first year done correctly

You arrive on a work visa, submit the permit kit at a post office within a week, attend your fingerprinting
appointment, and register with your comune. Your permit arrives some months later, with the receipt covering you
throughout.

### Building toward long-term status

Five years on, you've renewed twice without a gap and travelled home for a few weeks each year. Your absences are well
inside both limits, so you can apply for long-term residence with the income, accommodation and language requirements
to satisfy.

### One long absence late in the period

In year four you spend seven months abroad on a family matter. Your cumulative absence across the five years is still
modest, but that single trip exceeds the six-month limit and breaks continuity, pushing the long-term application back.

## Official sources

- [Polizia di Stato — Permesso di soggiorno](https://questure.poliziadistato.it/stranieri)
- [Ministero dell'Interno — Immigration and asylum](https://www.interno.gov.it/it/temi/immigrazione-e-asilo)

## FAQ

### How soon do I have to apply after arriving in Italy?

Within 8 working days of entry. The application goes in through a post office kit and is followed by an appointment for
fingerprinting at the immigration office.
...
Applying somewhat late can often be regularised, but leaving it lapsed without applying leaves you without lawful
status and breaks the continuity the long-term route depends on.

### Does long-term residence lead to Italian citizenship?

It's a separate application with its own requirements, including a generally longer residence period. Holding long-term
residence doesn't confer nationality by itself.
