...
sources:
  ...
  - title: Federal Authority for Identity, Citizenship, Customs and Port Security (ICP)
    ...
    type: official
  - title: The Official Portal of the UAE Government — Golden visa
...
digital, so the length of any absence is established from their system rather than from your account of it.
...
You take an eight-month assignment in another country without returning at any point. Your residence visa is cancelled
during that absence, and you discover it when you try to return as a resident.
...
Yes for this rule, since it measures continuous absence. Any entry breaks the continuity, and a new absence starts
counting from your next departure.

### What happens if I lose my job?

Sponsorship ends and a grace period begins, after which the residence lapses regardless of your travel history. Moving
to a new sponsor within that window is the usual route to keeping residence.
