...
family in the US. That evidence is the substance of the rule, far more than the day count is.

## Edge cases

- **Short returns don't reset anything reliably.** Coming back for a fortnight each year to "keep the card alive" is a
...
Your employer sends you overseas for two years. You apply for a re-entry permit before leaving, receive it, and travel
on it — so your absence carries no presumption of abandonment and your card stays valid for return.

### Brief visits that don't preserve residence

You've lived abroad for four years, returning for two weeks each year to use the card. No single absence reached a
year, but your home, work and life are demonstrably elsewhere, so an officer can find you abandoned residence despite
the regular entries.
...
Your card is no longer valid for re-entry. The route back is a returning resident visa from a US consulate, which
