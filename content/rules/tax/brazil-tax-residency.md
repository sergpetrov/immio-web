...
sources:
  - title: "Receita Federal — Resident and non-resident individuals"
...
### Temporary visa, straight past the count

You arrive in São Paulo on a temporary visa in early February and stay. You complete your 184th day of presence in
early August, so you're a Brazilian tax resident from that date and taxed on worldwide income from then on.

### Short of the threshold, so the clock restarts

You come and go on a temporary visa, adding up 170 days across the twelve months that ran from your first entry. You
never reach 184, so a fresh twelve-month period starts from your next entry and you stay a nonresident, taxed only on
your Brazilian-source income.

### Low day count, but the contract decides it

You arrive in November on a temporary visa with a signed Brazilian employment contract, and spend only 50 days in the
country before the year ends. The day count is nowhere near 184, but the employment relationship makes you a resident
from your arrival date.

## Official sources

- [Receita Federal — Resident and non-resident individuals](https://www.gov.br/receitafederal/pt-br/assuntos/meu-imposto-de-renda/preenchimento/dsdp/nao-residente)
- [Receita Federal — Normative Instruction SRF nº 208/2002 (residents and non-residents)](http://normas.receita.fazenda.gov.br/sijut2consulta/link.action?idAto=15079&visao=anotado)
...
### How do I stop being a Brazilian tax resident?

By filing the exit communication and the exit return when you leave permanently. Without them you remain resident for
the first twelve consecutive months of absence, and a purely temporary absence ends residency only from the day after
twelve consecutive months abroad.

### What changes once I become a resident?

Brazil taxes your **worldwide income**, not just income arising in Brazil, and you file as a resident taxpayer.
Nonresidents are generally taxed only on Brazilian-source income, usually collected by withholding at source.

### Can I be a tax resident of Brazil and another country at once?

Yes. Brazilian rules only decide your position under Brazilian law. If another country also treats you as resident, a
double tax treaty between the two would determine which has priority over particular types of income.
