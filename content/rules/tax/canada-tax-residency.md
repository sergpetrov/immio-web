...
seo:
  title: Canada Tax Residency Rules Explained | Immio
  description: >
    How Canadian tax residency works — the residential ties test, the
    183-day deemed-residency backstop, how sojourned days are counted,
    and how tax treaties can override both tests.

updatedAt: 2026-08-13

sources:
  - title: "Canada Revenue Agency — Income Tax Folio S5-F1-C1: Determining an Individual's Residence Status"
...
- **Factual residency** (ties) — you maintain significant residential ties to Canada, most importantly a home available to
  you, a spouse or common-law partner in Canada, or dependants in Canada. A collection of secondary ties — financial
  accounts, memberships, a driver's license, provincial health coverage — can reinforce a borderline case, though a
  single one rarely decides it alone.
- **Deemed residency** — if you don't have significant residential ties, you're still deemed resident if you sojourn
  (are temporarily present) in Canada for **183 days or more** in the calendar year.
...
### Is Canadian tax residency just about counting 183 days?

No. **Factual residency**, based on your residential ties, takes priority. The 183-day sojourner rule is a backstop
that only applies if you don't already have significant ties like a home, spouse, or dependants in Canada.

### What counts as a "significant residential tie" to Canada?

Most importantly, a home available to you, a spouse or common-law partner in Canada, or dependants in Canada. A
collection of secondary ties — bank accounts, memberships, a driver's licence, health coverage — can reinforce a
borderline case, though rarely decides one alone.

### Can I be a Canadian tax resident even with very few days in Canada?

Yes, through factual residency. If you maintain significant residential ties, you can remain a factual resident
even while spending almost no time physically in the country.

### What happens if I meet either residency test?

You become a Canadian tax resident for the year, taxed on your **worldwide income** — not just Canadian-source
income. Falling short of both tests instead makes you a nonresident, generally taxed only on Canadian-source income.

### Can a tax treaty make me a non-resident even if I meet Canada's own tests?

Yes. If a tax treaty's tie-breaker rules assign your residence to the other country, a specific statutory provision
deems you a non-resident for Canadian tax purposes, overriding both the factual and deemed residency tests.

### Does leaving Canada for an extended trip end my residency?

Not automatically. If you keep significant residential ties — a home, spouse, or dependants — while away, you can
remain a factual resident for the whole period you're gone, regardless of how long the trip lasts.
