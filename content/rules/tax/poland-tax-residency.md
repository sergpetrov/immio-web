---
id: poland-tax-residency

title: Poland Tax Residency (183-day rule)
...
sources:
  - title: "Personal Income Tax Act — Article 3 (tax residency), consolidated text"
    url: https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU20260000592
    type: official
  - title: "Ministry of Finance — Tax explanatory notes on tax residency"
...
You move to Warsaw in February and spend 230 days in Poland by year end, with your job and closest family also based
there. You clear the 183-day threshold easily, so you're a Polish tax resident for the year.

### Frequent short trips add up unexpectedly

You live just across the border and cross into Poland for work most weekdays without staying overnight, assuming only
full days would count. Because any part of a day counts as a full day present, your trips alone push you past 183
days, making you a Polish tax resident despite never staying the night.
...
- [Personal Income Tax Act — Article 3 (tax residency), consolidated text](https://isap.sejm.gov.pl/isap.nsf/DocDetails.xsp?id=WDU20260000592)
- [Ministry of Finance — Tax explanatory notes on tax residency](https://www.gov.pl/web/finanse/objasnienia-podatkowe-dotyczace-rezydencji-podatkowej)
...
### How are days in Poland counted toward the 183-day test?

Any part of a day counts as a full day present, including arrival, departure, weekends, and holidays. The days don't
need to be consecutive — the tax authority simply totals every day you were present during the calendar year.
...
You become a Polish tax resident for the whole calendar year, taxed on your **worldwide income** — not just income
...
It's an income tax exemption for people who move their tax residence to Poland, generally after not having been a
Polish tax resident for several years beforehand. It excludes part of your income from tax for several consecutive
years, on top of the standard tax-free allowance, subject to citizenship, residence-status, and documentation
conditions.
