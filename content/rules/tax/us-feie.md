...
sources:
  - title: "IRS — Foreign earned income exclusion"
    ...
    type: official
  - title: "IRS — Foreign earned income exclusion: physical presence test"
    url: https://www.irs.gov/individuals/international-taxpayers/foreign-earned-income-exclusion-physical-presence-test
    type: official
  - title: "IRS — Foreign earned income exclusion: bona fide residence test"
    url: https://www.irs.gov/individuals/international-taxpayers/foreign-earned-income-exclusion-bona-fide-residence-test
    type: official
  - title: "IRS — Foreign earned income exclusion: tax home in foreign country"
...
Nothing works without a **foreign tax home** first. Your tax home is the general area of your main place of business or
post of duty. You don't have a foreign one for any period in which your abode stays in the United States — abode
meaning where your economic, family and personal ties actually sit. Work you expect to last a year or less is
temporary and doesn't move your tax home; work expected to run longer is indefinite and does.

With a foreign tax home in place, you qualify through either of two routes, in any order:

- **Physical presence test** — physically present in a foreign country or countries for at least 330 full days during
  any period of 12 consecutive months. It's a pure day count, and your intentions and ties are irrelevant to it.
- **Bona fide residence test** — you're a bona fide resident of a foreign country for an uninterrupted period that
  includes an entire tax year. There's no day count here: it turns on your purpose for being there, your activities,
  and whether you paid tax to that country.

Meeting either route lets you exclude foreign earned income up to the annual cap. A separate foreign housing exclusion
can cover qualifying housing costs on top of that.

The bona fide residence route is narrower in who can use it. It's open to US citizens, and to US residents who are
citizens or nationals of a country with a US income tax treaty in force — the physical presence test has no such
...
You move to Lisbon in January on an open-ended contract, work there all year, and make two trips home totalling 20
days in the US. Even after discounting the four travel days, you're well past 330 full days abroad, so the physical
presence test qualifies you.

### Trips home that eat the whole allowance

You work in Singapore but come back to the US for 25 days of client meetings and a two-week holiday — 39 days in all.
A 330-day threshold leaves roughly 35 days of slack in a year, so you miss it, and each travel day counts against you
on top.

### A perfect day count with your life still in the US

You spend the entire year in Mexico and never set foot in the US, but your home, family and finances stay in Chicago
and your employer treats the posting as a nine-month assignment. Your day count is flawless, yet your abode remains in
the US, so you have no foreign tax home and neither route can help.
...
- [IRS — Foreign earned income exclusion: bona fide residence test](https://www.irs.gov/individuals/international-taxpayers/foreign-earned-income-exclusion-bona-fide-residence-test)
- [IRS — Foreign earned income exclusion: tax home in foreign country](https://www.irs.gov/individuals/international-taxpayers/foreign-earned-income-exclusion-tax-home-in-foreign-country)

## FAQ

### Does qualifying mean I'm no longer a US taxpayer?

No. A US citizen stays taxable on **worldwide income** no matter where they live, and this doesn't change that. It
only takes foreign earned income out of the amount you're taxed on, up to a cap, and you still file a US return every
year.

### How is a "full day" counted for the physical presence test?

A full day is 24 consecutive hours from midnight to midnight spent entirely in a foreign country. Days you travel
between the US and abroad generally don't count, and time over international waters isn't time in a foreign country
either.

### Can I use the 330-day test if I moved abroad partway through the year?

Yes. The twelve-month window doesn't have to match the calendar year — you can use any twelve consecutive months that
include part of the tax year, choosing the window that gives the largest exclusion. Where your qualifying period
covers only part of the year, the cap is prorated to the qualifying days.

### Do I still have to file a US return if the exclusion covers all my income?

Yes. The exclusion is claimed on Form 2555 with your return, so it only applies if you file one. A late election can
also be denied once the IRS has already discovered that you didn't file.

### Does the exclusion cover self-employment tax?

No. Excluded income still counts for self-employment tax, so a self-employed American abroad can owe US tax on income
that's fully excluded for income-tax purposes. A totalization agreement with the country you live in may remove that
charge instead.

### Should I take the exclusion or the foreign tax credit?

It largely depends on local tax rates. In a high-tax country the credit often covers the whole US bill on its own,
while in a low-tax or no-tax country the exclusion usually does more. The two can't apply to the same income, and
switching away from the exclusion generally locks you out of it for five years.
