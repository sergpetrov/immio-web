...
seo:
  title: Indonesia Business Visa – 60 Days Per Visit Limit | Immio
  description: >
    The business visit visa gives 60 days on arrival and extends twice by 60
    days each, to 180 days in one stay. It needs a sponsor and covers visits,
    not work.
...
on each trip — meeting invitations, conference registrations, correspondence. If the purpose of your visit is
questioned, that evidence is what distinguishes a business visit from undeclared work.
...
A negotiation drags on and you need close to six months. You take both extensions in sequence, each applied for before
the previous permission lapsed, reaching the 180-day maximum — at which point you have to leave regardless.

### The line into prohibited work

You arrive for meetings, then agree to spend a month building a system for the Indonesian client directly, invoiced
locally. The day count is irrelevant here: delivering paid services to an Indonesian client is work, which this visa
doesn't permit.
...
Business meetings, contract negotiations, supplier and factory visits, conferences, seminars and audits. It does not
allow employment, delivering paid services to Indonesian clients, or receiving a salary from an Indonesian source.

### Do I need a sponsor?

Yes. An Indonesian company or authorised individual must sponsor the visa and takes formal responsibility for your
visit. This is applied for before you travel, not on arrival.
...
Working for your own overseas employer on your own overseas payroll is not what this visa targets, but Indonesia has
been tightening its position on remote work generally. Anything touching Indonesian clients or Indonesian payment is
clearly outside it.
