...
sources:
  - title: US Customs and Border Protection — Electronic System for Travel Authorization (ESTA)
    ...
    type: official
  - title: US Department of State — Visa Waiver Program
...
- **An approved ESTA is not a guarantee of entry.** It permits boarding and a request for admission. The officer can
  still refuse, and refusal under the programme carries very limited rights of review.
- **Changing passports invalidates the ESTA.** A new passport, or a change of name or nationality, means a new ESTA —
  the authorisation is tied to the specific passport.
- **A previous overstay usually ends your access to the programme.** Once you've overstayed under the Visa Waiver
  Program, future visits generally require applying for a visa instead.
...
You apply for an ESTA a week before flying, are approved, and spend 12 days in the US on holiday. You're far inside the
90 days, and the same ESTA covers further trips for the next 2 years.

### A side trip that doesn't buy more time

You're admitted for 90 days, spend 70 in the US, then take a 10-day trip to Mexico expecting a fresh 90 on return.
You're readmitted for the remainder instead, and the Mexican days may count too — leaving days rather than months.
...
- [US Customs and Border Protection — Electronic System for Travel Authorization (ESTA)](https://esta.cbp.dhs.gov/)
...
Normally not. You're usually readmitted only for the balance of your original 90-day admission, and the time spent in
those neighbouring countries often counts toward it as well.

### How long is an ESTA valid?

Two years, or until your passport expires if that comes sooner. That validity covers repeated travel, with each
individual visit still limited to 90 days.

### Is ESTA a visa?

No. It's a pre-travel authorisation that lets you board a carrier and request admission. A visa is a different
document with different rights — notably the ability to extend a stay and to contest a removal decision.
...
Yes. The authorisation is tied to the passport it was issued against, so a new passport — or a change of name or
nationality — requires a new ESTA application.
