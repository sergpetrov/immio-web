...
const Terms: React.FC = () => {
  const termsHtml = `
    ...
    <p>Your data is stored <strong>only on your device and in your personal iCloud account</strong> (if enabled). We do not collect, access, or transmit your personal data to our servers. For details, see our <a href="#">Privacy Policy</a>.</p>
    ...
    <p>If you have any questions, please contact us at: <strong><a href="mailto:support@devmode.ltd">support@devmode.ltd</a></strong></p>
  `;

  return (
    <div style={{ maxWidth: 800, margin: '40px auto', padding: '0 20px', textAlign: 'left' }}>
